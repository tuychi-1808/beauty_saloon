      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="{{route('beauty_saloon/index')}}">Home</a></span> <span class="mr-2"><a href="{{route('beauty_saloon/blog')}}">Blog</a></span> <span>Blog Details</span></p>
          </div>
        </div>
      </div>
    </div>
